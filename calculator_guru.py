...
import time
root =Tk()
root.title("Calculator Guru(Mercan)")
e = Entry(root, width=49, borderwidth=9, relief=RIDGE, fg="black", bg="white")
...
clock_label = Label(root, font=('calibri', 20, ), background='aqua', foreground='black')
clock_label.grid(row=8, column=0, columnspan=8, pady=50,padx=100)
update_clock()

log = Button(root, text="log", padx=29, pady=10, relief=RAISED, bg="Black", fg="White")
...
exp = Button(root, text="^", padx=33, pady=10, relief=RAISED, bg="Black", fg="White", command=lambda: click("**"))
...
sqrtm = Button(root, text="Sqrt", padx=27, pady=10, relief=RAISED, bg="Black", fg="White")
sqrtm.bind("<Button-1>", sc)
ac = Button(root, text="C", padx=28, pady=10, relief=RAISED, bg="Dark Red", fg="White",command=lambda: clear())
bksp = Button(root, text="Del", padx=23, pady=10, relief=RAISED, bg="Dark Red", fg="White",command=lambda: bksps())
mod = Button(root, text="mod", padx=20, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("%"))
div = Button(root, text="/", padx=28, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("/"))

fact = Button(root, text="x!", padx=33, pady=10, relief=RAISED, bg="Black", fg="White")
...
frac = Button(root, text="1/x", padx=29, pady=10, relief=RAISED, bg="Black", fg="White")
...
pib = Button(root, text="pi", padx=32, pady=10, relief=RAISED, bg="Black", fg="White")
...
plus = Button(root, text="+", padx=28, pady=10, relief=RAISED, bg="Black", fg="White",command=lambda: click("+"))
